  ...
  return (
    <div className="top-36 flex group relative cursor-pointer">
      <motion.img
        ...
        className="rounded-full border  border-gray-500 object-cover w-24 h-24 xl:w-32 xl:h-32 md:h-28 md:w-28 filter relative
        group-hover:grayscale transition duration-300 ease-in-out"
      />
      <div className="flex absolute opacity-0 group-hover:opacity-80 transition duration-300
      ease-in-out group-hover:bg-white xl:h-32 xl:w-32 w-24 h-24 md:h-28 md:w-28 
      rounded-full z-0 items-center justify-center">
